"""チェスの CPU — 完成: 評価関数とミニマックス（negamax）、αβ 枝刈り、反復深化と時間制限。"""
...
def main():
    ...
    game = Game(cpu=None if args.two else args.cpu, fen=args.fen,
                seconds=None if args.depth else args.time, depth=args.depth)
