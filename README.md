...
| g81 | [軽飛行機で輪をくぐる](g81-flight-rings/) | 山と谷の上の 12 個の輪を順にくぐる 3D フライト。向きを 3 本のベクトルで持つ 3 軸の回転、内積だけで見るカメラ、高さの表から作る地形、傾く地平線 | ロドリゲスの回転公式 / `Frame(NamedTuple)` の前・上・右 / 双一次補間 / LOD（遠くはまとめて描く） / 面をまたいだ瞬間の補間 |
