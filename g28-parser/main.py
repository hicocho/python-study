"""コマンド解析 — 完成: 「look at the 燭台」のような文を分解し、同義語と「もしかして」で受ける。"""
...
# 動詞と、その言い換え。プレイヤーがどう打っても、左の 1 語に寄せる
VERBS = {
...
def main():
    ...
    game = Game()
    print("「look at the 燭台」「examine 地図」「go north」「北」のように打つ。help で使える言葉、q でやめる。\n")
    print(game.look())
