"""パックマン風 — 完成: パワーエサとイジケ。食べるとおばけが逃げ、捕まえると 200・400・800・1600 点。目玉だけになって巣へ帰る。"""
...
def main():
    parser = argparse.ArgumentParser(description="パックマン風 — パワーエサとイジケ")
    ...
    if problem := check_terminal():
        print(problem)
        return
    play(Game(seed=args.seed, skill=args.skill), auto=args.auto)
