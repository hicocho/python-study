...
CLI 版（g40-dfpn/main.py）と駒・盤・手の生成・成り・持ち駒はまったく同じ。
Piece / Square / Move / Board（do / undo / zobrist）、trying() / attacked() / in_check() / legal_moves() / evasions()、Solver（全探索）/ DfPn（証明数・反証数）、PROBLEMS、make_move() / describe()、
